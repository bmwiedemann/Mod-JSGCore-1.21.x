...
public class JSGAdvancementProvider implements AdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper fileHelper) {
        ...
        AdvancementHolder emptyPage = Advancement.Builder.advancement()
                .parent(root)
                .display(
        ...
        AdvancementHolder lemon = Advancement.Builder.advancement()
                .parent(emptyPage)
                .display(
        ...
        AdvancementHolder trapLemon = Advancement.Builder.advancement()
                .parent(lemon)
                .display(
        ...
        AdvancementHolder exposed = Advancement.Builder.advancement()
                .parent(copper)
                .display(
        ...
        AdvancementHolder weathered = Advancement.Builder.advancement()
                .parent(exposed)
                .display(
        ...
        AdvancementHolder titanium = Advancement.Builder.advancement()
                .parent(copper)
                .display(
        ...
        AdvancementHolder cauldron = Advancement.Builder.advancement()
                .parent(copper)
                .display(
                        Blocks.CAULDRON,
        ...
        AdvancementHolder advanced_circuit = Advancement.Builder.advancement()
                .parent(circuit)
                .display(
        ...
        AdvancementHolder efficiency_crystal = Advancement.Builder.advancement()
        ...
        AdvancementHolder liquidNaquadah = Advancement.Builder.advancement()
                .parent(cauldron)
                .display(
        ...
        AdvancementHolder naquadahAlloy = Advancement.Builder.advancement()
        ...
        AdvancementHolder clusterBlue = Advancement.Builder.advancement()
                .parent(emptyPage)
                .display(
        ...
        AdvancementHolder clusterRed = Advancement.Builder.advancement()
                .parent(clusterBlue)
                .display(
        ...
        AdvancementHolder clusterEnder = Advancement.Builder.advancement()
                .parent(clusterRed)
                .display(
        ...
        AdvancementHolder clusterYellow = Advancement.Builder.advancement()
                .parent(clusterEnder)
                .display(
        ...
        AdvancementHolder clusterWhite = Advancement.Builder.advancement()
        ...
        AdvancementHolder seedBlue = Advancement.Builder.advancement()
                .parent(clusterBlue)
                .display(
        ...
        AdvancementHolder seedRed = Advancement.Builder.advancement()
                .parent(seedBlue)
                .display(
        ...
        AdvancementHolder seedEnder = Advancement.Builder.advancement()
                .parent(seedRed)
                .display(
        ...
        AdvancementHolder seedYellow = Advancement.Builder.advancement()
                .parent(seedEnder)
                .display(
        ...
        AdvancementHolder seedWhite = Advancement.Builder.advancement()
                .parent(seedYellow)
                .display(
