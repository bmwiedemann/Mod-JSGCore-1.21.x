...
public class JSGAxisAlignedBB extends AABB {
    ...
    public JSGAxisAlignedBB move(BlockPos pPos) {
        return new JSGAxisAlignedBB(this.minX + (double)pPos.getX(), this.minY + (double)pPos.getY(), this.minZ + (double)pPos.getZ(), this.maxX + (double)pPos.getX(), this.maxY + (double)pPos.getY(), this.maxZ + (double)pPos.getZ());
    }
