...
public class ScheduledTask implements INBTSerializable<CompoundTag> {
    ...
    private dev.tauri.jsg.core.common.entity.ScheduledTaskType scheduledTask;
    ...
    public ScheduledTask(Supplier<ScheduledTaskType> scheduledTask) {
    ...
    public ScheduledTask(Supplier<ScheduledTaskType> scheduledTask, CompoundTag customData) {
        this(scheduledTask.get(), customData);
    }
    ...
    public ScheduledTask(Supplier<ScheduledTaskType> scheduledTask, int waitTime) {
        this(scheduledTask.get(), waitTime);
    }
    ...
    public ScheduledTask(Supplier<ScheduledTaskType> scheduledTask, int waitTime, CompoundTag customData) {
        this(scheduledTask.get(), waitTime, customData);
    }
    ...
    public void execute() {
        try {
            ...
            JSGCore.logger.error("UnsupportedOperationException", e);
        }
    }
    ...
    public CompoundTag serializeNBT() {
        ...
        compound.putString("scheduledTask", scheduledTask.getKey().toString());
    ...
    public void deserializeNBT(CompoundTag compound) {
        ...
        scheduledTask = ScheduledTaskType.valueOf(JSGMapping.rl(compound.getString("scheduledTask")));
