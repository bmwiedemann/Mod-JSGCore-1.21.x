...
public class CoreBlocks {
    ...
    public static final RegistryObject<Block> RAW_ORE_NAQUADAH_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("raw_naquadah_ore_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.RAW_IRON_BLOCK).mapColor(MapColor.COLOR_GREEN)).buildGeneric();
    public static final RegistryObject<Block> RAW_ORE_TITANIUM_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("raw_titanium_ore_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.RAW_IRON_BLOCK).mapColor(MapColor.COLOR_GRAY)).buildGeneric();
    public static final RegistryObject<Block> RAW_ORE_TRINIUM_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("raw_trinium_ore_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.RAW_IRON_BLOCK).mapColor(MapColor.COLOR_LIGHT_GRAY)).buildGeneric();

    public static final RegistryObject<Block> NAQUADAH_RAW_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("naquadah_alloy_raw_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).mapColor(MapColor.COLOR_GREEN)).buildGeneric();
    public static final RegistryObject<Block> NAQUADAH_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("naquadah_alloy_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).mapColor(MapColor.COLOR_LIGHT_BLUE)).buildGeneric();
    public static final RegistryObject<Block> NAQUADAH_REFINED_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("naquadah_alloy_refined_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).mapColor(MapColor.EMERALD)).buildGeneric();
    public static final RegistryObject<Block> TITANIUM_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("titanium_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).mapColor(MapColor.METAL)).buildGeneric();
    public static final RegistryObject<Block> TRINIUM_BLOCK = CoreRegistryHelpers.BLOCK_HELPER.builder("trinium_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).mapColor(MapColor.QUARTZ)).buildGeneric();

    /**
     * CRYSTAL
     */
    public static final Map<ICrystalColor, RegistryObject<Block>> CRYSTAL_BLOCK = CoreRegistryHelpers.ORE_HELPER.builder("{color}_crystal_block").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_BLOCK)).buildCrystalBlock();
    ...
    public static final Map<OreBlockVariant, Map<ICrystalColor, RegistryObject<Block>>> UNSTABLE_CRYSTAL_BUDDING = CoreRegistryHelpers.ORE_HELPER.builder("unstable_budding_{color}_crystal").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST)).buildCrystalUnstableBuddings(() -> CRYSTAL_BUDDING, () -> CRYSTAL_BLOCK);

    public static final RegistryObject<Block> LEMON_BLOCK = REGISTER.register("lemon", LemonBlock::new);
    public static final RegistryObject<Block> STATIC_SMOOTH_SANDSTONE = CoreRegistryHelpers.BLOCK_HELPER.builder("static_smooth_sandstone").clearTooltip().setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.SMOOTH_SANDSTONE).pushReaction(PushReaction.BLOCK)).setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).buildGeneric();
    public static final RegistryObject<Block> BRAZIER_COAL = CoreRegistryHelpers.BLOCK_HELPER.builder("brazier_coal").clearTooltip().setInTabs(List.of(CoreTabs.TAB_BUILDING_BLOCKS)).setProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.COAL_BLOCK).mapColor(MapColor.COLOR_BLACK)).buildGeneric();
