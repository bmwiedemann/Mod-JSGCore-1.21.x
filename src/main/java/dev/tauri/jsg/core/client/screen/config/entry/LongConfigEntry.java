...
public class LongConfigEntry extends AbstractConfigEntry {
    protected EditBox textField;
    protected JSGConfigValue.LongValue value;

    public LongConfigEntry(Component component, int screenWidth, JSGConfigValue.LongValue value) {
        super(value);
        this.value = value;
    ...
    protected void onChanged() {
        ...
        value.set(Long.parseLong(this.textField.getValue()));
    }
