package dev.tauri.jsg.core.client.screen.config.entry;
...
public class IntConfigEntry extends dev.tauri.jsg.core.client.screen.config.entry.AbstractConfigEntry {
    protected EditBox textField;
    protected JSGConfigValue.IntValue value;

    public IntConfigEntry(Component component, int screenWidth, JSGConfigValue.IntValue value) {
        super(value);
        this.value = value;
    ...
    protected void onChanged() {
        ...
        value.set(Integer.parseInt(this.textField.getValue()));
    }
